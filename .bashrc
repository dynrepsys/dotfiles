...
#tpid=$(xinput --list | grep "TouchPad" | grep -Po "(?<=id=)[0-9]*")
#echo "Setting properties for TouchPad at" $tpid
#xinput --set-prop $tpid "Synaptics Finger" 48 64 128
#xinput --set-prop $tpid "Synaptics Noise Cancellation" 25 25 
#Synaptics Pressure Motion" 30 160
#Synaptics Coasting Speed 20
#Synaptics Noise Cancellation 8 8

export PROMPT_COMMAND="${PROMPT_COMMAND:+$PROMPT_COMMAND$'\n'}history -a;"

export GPGKEY=035274C7
